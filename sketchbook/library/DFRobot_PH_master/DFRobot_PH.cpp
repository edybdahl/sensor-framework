...
DFRobot_PH::DFRobot_PH()
{
    ...
    this->_phValue        = 7.0;
    this->_acidVoltage    = 2032.44;    //buffer solution 4.1 at 25C
...
{
    float slope = (7.0-4.1)/((this->_neutralVoltage-1500.0)/3.0 - (this->_acidVoltage-1500.0)/3.0);  // two point: (_neutralVoltage,7.0),(_acidVoltage,4.0)
